...
import { degreeCourses, categories as courseCategories } from './coursesData'

// Dynamically import NavBar and Footer
const NavBar = dynamic(() => import('../../NavBar'), { ssr: true })
const Footer = dynamic(() => import('../../Footer'), { ssr: true })

// OLD Course data based on Arden University degrees (replaced by coursesData import)
...
// Removed - now using imported categories from coursesData
// const categories = [...new Set(degreeCourses.map(course => course.category))]
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Explore Our <span className="text-red-600">Degree Courses</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover world-class undergraduate degree programmes designed to prepare you for success in your chosen career. Study at British AUC University Study Centre and earn your UK degree.
            </p>
            <div className="flex flex-wrap justify-center gap-6 pt-4">
              <div className="flex items-center gap-2 text-gray-700">
                <BookOpen className="w-5 h-5 text-red-600" />
                <span className="font-medium">{degreeCourses.length} Programmes</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <Building2 className="w-5 h-5 text-red-600" />
                <span className="font-medium">Multiple Study Locations</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="bg-white border-b border-gray-200 sticky top-20 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <div className="mt-4 text-sm text-gray-600">
            Showing <span className="font-semibold text-gray-900">{filteredCourses.length}</span> of <span className="font-semibold text-gray-900">{degreeCourses.length}</span> courses
          </div>
        </div>
      </section>
              ...
              {filteredCourses.map((course, index) => (
                ...
                >
                  ...
                  <div className="p-6 pt-0">
                    <Link
                      href={`/courses/degrees/${course.id}`}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white">
              Ready to Start Your Degree Journey?
            </h2>
            <p className="text-white/90 text-lg max-w-2xl mx-auto">
              Take the first step towards your future. Apply now or speak with our admissions team to learn more about our programmes.
            </p>
